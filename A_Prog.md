...
- [ ] **T10** — `POST /auth/register` endpoint &nbsp;·&nbsp; _Completed:_
- [ ] **T11** — `POST /auth/login` endpoint &nbsp;·&nbsp; _Completed:_
- [ ] **T12** — `verifyToken` middleware (`middleware/verifyToken.js`) &nbsp;·&nbsp; _Completed:_
- [ ] **T13** — `GET /users/me`, `PUT /users/me`, `DELETE /users/me` endpoints &nbsp;·&nbsp; _Completed:_

---

## Phase 4 — Core API Routes

- [ ] **T14** — Course CRUD routes &nbsp;·&nbsp; _Completed:_
- [ ] **T15** — Document upload route (`POST /courses/:courseId/documents`, multer) &nbsp;·&nbsp; _Completed:_
- [ ] **T16** — `GET /courses/:courseId/documents`, `DELETE /documents/:id` &nbsp;·&nbsp; _Completed:_
- [ ] **T17** — Task CRUD routes &nbsp;·&nbsp; _Completed:_
